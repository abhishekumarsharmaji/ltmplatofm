...
export function TermsPage() {
  return <CompliancePage title="Terms and Conditions" intro="These terms govern access to and use of the CoreSkils website, courses, digital products and related services." sections={[
    { title: "1. About CoreSkils", paragraphs: [`${BUSINESS.platform} is operated by ${BUSINESS.legalName} from ${BUSINESS.address}. The platform enables independent instructors to publish educational content and enables learners to discover and access that content.`] },
    ...
    { title: "4. Courses and digital products", paragraphs: ["Descriptions, included materials, access conditions and prices displayed on the relevant product page form part of the offer. Digital access is supplied electronically. Instructors remain responsible for the accuracy and legality of content they publish."], bullets: ["Content is licensed for the purchaser’s personal, non-transferable use.", "You may not resell, share, record, scrape, reproduce or redistribute content without written permission.", "Course outcomes depend on the learner’s effort; no employment, income or qualification outcome is guaranteed."] },
    ...
    { title: "6. Cancellations and refunds", paragraphs: ["Refund eligibility is governed by the Refund and Cancellation Policy published on this website. Because courses and files are digitally delivered, access or download may limit refund eligibility, except for duplicate charges, verified technical failure, or rights that cannot be excluded under applicable law."] },
    { title: "7. Acceptable use", bullets: ["Do not use the platform for unlawful, fraudulent or abusive activity.", "Do not bypass access controls, payment checks, download restrictions or platform security.", "Do not upload malware or content that infringes privacy, intellectual property or other rights.", "Do not impersonate another person or misrepresent credentials, reviews or course outcomes."] },
    { title: "8. Intellectual property", paragraphs: ["The CoreSkils brand, platform design and software are protected by applicable intellectual-property laws. Instructor content belongs to the instructor or its stated rights holder. No ownership transfers to a learner through access or purchase."] },
...
export function PrivacyPage() {
  return <CompliancePage title="Privacy Policy" intro="This policy explains what personal information CoreSkils collects, why it is used, when it is shared, and the choices available to you." sections={[
    ...
    { title: "2. Information we collect", bullets: ["Account details such as name, email address, role and authentication information.", "Course enrolment, lesson progress, wishlist, order and entitlement records.", "Creator profile, application and content information submitted by instructors.", "Payment references, status, amount and provider identifiers; complete payment credentials are handled by the payment gateway.", "Device, browser, IP address, security logs and service-usage information.", "Messages and support information you voluntarily provide."] },
    { title: "3. Why we use information", bullets: ["Provide accounts, course access, downloads and customer support.", "Process and verify payments, refunds and entitlements.", "Operate creator tools and administer the marketplace.", "Prevent fraud, abuse and unauthorised access.", "Comply with accounting, tax, legal and regulatory obligations.", "Improve reliability and performance using aggregated or limited technical data.", "Send essential service messages and, only where permitted, marketing communications."] },
...
export function RefundPage() {
  return <CompliancePage title="Refund and Cancellation Policy" intro="This policy applies to paid courses and downloadable digital products purchased through CoreSkils once online payments are enabled." sections={[
    { title: "1. Digital-delivery rule", paragraphs: ["Courses and downloadable products are supplied digitally. A purchase is generally not refundable after course access has started, protected content has been viewed, or a file has been downloaded. This rule prevents completed digital delivery from being reversed."] },
    ...
    { title: "4. Non-refundable cases", bullets: ["Course lessons or protected materials have been accessed.", "A digital file has been downloaded or its delivery link used.", "The request is based on change of mind, lack of time, or failure to complete the course.", "The user violated platform rules, shared access or attempted to bypass security.", "The request lacks enough information to verify the transaction after reasonable follow-up."] },
...
export function DeliveryPage() {
  return <CompliancePage title="Shipping and Delivery Policy" intro="CoreSkils currently supplies courses and digital products electronically. No physical shipment is involved unless a product page expressly states otherwise." sections={[
    { title: "1. Delivery method", paragraphs: ["After a successful payment is verified, course access is added to the learner’s account and downloadable products are made available through the authenticated library or secure download flow. Access details may also be sent to the registered email address."] },
      ...
      <main className="min-h-screen bg-[#FAFAFA] pb-20 pt-28 sm:pt-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl rounded-2xl border border-[#E5E5E5] bg-white p-7 shadow-sm sm:p-12">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-[#4D4D4D]">For account, course, creator, payment, delivery, refund or privacy questions, contact us using the verified details below.</p>
