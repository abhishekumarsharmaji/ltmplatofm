...
export const getGetMarketplaceCourseUrl = (id: string,) => {
...
export const getMarketplaceCourse = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<Course> => {
...
export const getGetMarketplaceCourseQueryOptions = <TData = Awaited<ReturnType<typeof getMarketplaceCourse>>, TError = ErrorType<void>>(id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarketplaceCourse>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetMarketplaceCourse<TData = Awaited<ReturnType<typeof getMarketplaceCourse>>, TError = ErrorType<void>>(
 id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarketplaceCourse>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
