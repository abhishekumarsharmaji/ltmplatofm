...
export type ZapUpiPaymentOrderProductType = typeof ZapUpiPaymentOrderProductType[keyof typeof ZapUpiPaymentOrderProductType];


export const ZapUpiPaymentOrderProductType = {
  course: 'course',
  digital: 'digital',
} as const;
...
export interface ZapUpiPaymentOrder {
  ...
  productType?: ZapUpiPaymentOrderProductType;
  /** @nullable */
