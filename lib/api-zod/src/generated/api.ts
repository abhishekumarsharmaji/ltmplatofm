...
export const updateCreatorCourseBasicsBodyPublicSlugMin = 3;
export const updateCreatorCourseBasicsBodyPublicSlugMax = 80;

export const updateCreatorCourseBasicsBodyPriceMinorMin = 0;


export const updateCreatorCourseBasicsBodyTrialDaysMin = 0;
export const updateCreatorCourseBasicsBodyTrialDaysMax = 90;
...
export const UpdateCreatorCourseBasicsBody = zod.object({
  ...
  "categoryId": zod.number().int().nullish(),
  "publicSlug": zod.string().min(updateCreatorCourseBasicsBodyPublicSlugMin).max(updateCreatorCourseBasicsBodyPublicSlugMax).optional(),
  "priceMinor": zod.number().int().min(updateCreatorCourseBasicsBodyPriceMinorMin).optional(),
  "currency": zod.enum(['INR']).optional(),
  "accessPlan": zod.enum(['lifetime', 'fixed_days', 'monthly', 'yearly']).optional(),
  "accessDays": zod.number().int().min(1).nullish(),
  "trialDays": zod.number().int().min(updateCreatorCourseBasicsBodyTrialDaysMin).max(updateCreatorCourseBasicsBodyTrialDaysMax).optional()
})
...
export const GetZapUpiPaymentOrderResponse = zod.object({
  ...
  "productType": zod.enum(['course', 'digital']).optional(),
  "courseId": zod.number().int().nullish(),
  "files": zod.array(zod.object({
  "id": zod.number().int(),
  "filename": zod.string(),
  "sizeBytes": zod.number().int().nullish()
